var LANGUAGES = {
    ...
    "cn": {
        ...
        texts: {
            "page-title": "我嘞个豆",
            "doc-title": "我嘞个豆~",
            "page-descriptions": "给阿梓宝写的小网站",
            "counter-descriptions": ["阿梓已经我勒个豆~了", "阿梓已经豆了"],
            "counter-unit": ["次", "次"],
            "counter-button": ["我嘞个豆~", "我嘞个豆！"],
...
(() => {
    ...
    cacheStaticObj("/ciallo/static/img/1.png");
    cacheStaticObj("/ciallo/static/img/2.png");
    ...
    function animateHerta() {
        let id = null;
        const random = [1, 2, 3, 4][Math.floor(Math.random() * 4)];
        const elem = document.createElement("img");
        let RunSpeed = Math.floor(current_speed);
        elem.src = cacheStaticObj(`/ciallo/static/img/${random}.png`);
