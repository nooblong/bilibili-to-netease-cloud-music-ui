        ...
        if (!data || data.length === 0) {
            return (
                <div className="flex flex-col items-center py-12 text-center text-gray-400 font-mono">
                    <div className="w-24 h-24 rounded-full bg-slate-900 border-2 border-cyan-500/20 flex items-center justify-center mb-4">
        ...
        <div className="px-2 py-3 md:px-4 md:py-4 rounded-b-lg border-t border-cyan-500/20 bg-black/20">
            ...
            {showFilter && (
                <div className="flex flex-col sm:flex-row items-start sm:items-center py-4 space-y-4 sm:space-y-0 sm:space-x-6">
                    <div className="w-full sm:w-auto relative group">
                        <div className="absolute inset-0 rounded-md bg-gradient-to-r from-cyan-500/30 to-blue-500/30 opacity-0 group-hover:opacity-100 transition-opacity blur-lg"></div>
                        <Input
                            ref={inputRef}
                                ...
                                <TableRow>
                                    ...
                                    >
                                        <div className="flex flex-col items-center py-8">
                                            <div className="w-16 h-16 rounded-full bg-slate-900 border-2 border-cyan-500/20 flex items-center justify-center mb-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 py-4">
                <div className="flex flex-wrap gap-2 items-center">
                    ...
                    {!isMobile && (
                        <>
                            <div className="px-3 py-1 border-2 border-cyan-500/40 text-cyan-400 bg-black/70 rounded-md text-xs font-mono">
                                页码: {pageNo}
                            </div>
                            <div className="px-3 py-1 border-2 border-cyan-500/40 text-cyan-400 bg-black/70 rounded-md text-xs font-mono">
                                每页: {pageSize}
