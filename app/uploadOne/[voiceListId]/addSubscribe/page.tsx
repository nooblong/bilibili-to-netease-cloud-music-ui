    ...
    return (
        <SidebarProvider>
            ...
            <SidebarInset className="bg-gradient-to-b from-slate-950 to-indigo-950 text-white relative overflow-hidden">
                ...
                {/* 内容 */}
                <header className="relative z-10 flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear bg-black/40 backdrop-blur-sm border-b border-purple-500/30 px-4">
