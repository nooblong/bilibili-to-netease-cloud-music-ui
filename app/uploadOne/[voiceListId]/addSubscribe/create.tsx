                                ...
                                {upInfo && (
                                    <div className="mt-4 p-4 bg-purple-50 rounded-lg">
                                        <div className="flex items-center space-x-4">
                                            {upInfo.face && (
                                                <div className="rounded-full overflow-hidden border-2 border-purple-300 h-20 w-20 flex-shrink-0">
                                                    <Image
                                                        unoptimized
                                                        width={80}
                                                        height={80}
                        ...
                        <CardContent className="p-6">
                            <div className="space-y-6">
                                ...
                                <div className="border-t border-purple-100 pt-6 mt-6">
                                    ...
                                    <div className="flex items-center space-x-3 p-3 mt-4 rounded-lg border border-purple-200 bg-purple-50">
                                        <div className="flex items-center space-x-2">
                                            <Switch
                                                id="airplane-mode"
                                                onCheckedChange={(checked) => {
                                ...
                                <div className="border-t border-purple-100 pt-6 mt-6">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <FormField
                                            ...
                                            name="useVideoCover"
                                            render={({ field }) => (
                                                <FormItem className="flex items-center space-x-3 p-3 rounded-lg border border-purple-100 hover:bg-purple-50 transition-all">
                                                    <FormControl>
                                                        <Checkbox
                                                            checked={
                                                                field.value ===
