      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4 bg-slate-900/50 border border-cyan-500/30 rounded-lg p-4">
            ...
            {upInfo && (
              <div
                className="p-3 border border-cyan-500/20 rounded-lg bg-slate-900/30 transition-all hover:bg-slate-900/50 hover:border-cyan-500/40 duration-300">
                <p className="text-cyan-300 font-semibold mb-2">
                  {upInfo.name}
                </p>
                {upInfo.face && (
                  <div
                    className="relative w-16 h-16 overflow-hidden rounded-full border-2 border-cyan-500/50 shadow-lg shadow-cyan-500/20">
                    <Image
                      unoptimized
                      width={100}
                      height={100}
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem className="bg-slate-900/50 border border-cyan-500/30 rounded-lg p-4">
                ...
                <div
                  className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2 max-h-60 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-cyan-500 scrollbar-track-slate-900">
                  {favInfo.length > 0 ? (
                    favInfo.map((item) => (
                      <FormControl key={item.id}>
                        <div
                          className="flex items-center space-x-2 p-2 rounded-md hover:bg-slate-800/50 transition-colors">
                          <Checkbox
                            id={`fav-${item.id}`}
            ...
            render={({field}) => (
              <FormItem className="transition-all duration-300 hover:scale-[1.01]">
                ...
                <FormControl>
                  ...
                  >
                    <SelectTrigger
                      className="bg-slate-900/50 border-cyan-500/30 focus:border-cyan-400 focus:ring-cyan-400/20 text-white">
        ...
        <div className="bg-slate-900/50 border border-cyan-500/30 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <FormField
              ...
              render={({field}) => (
                <FormItem
                  className="flex items-center space-x-3 rounded-lg border border-cyan-500/10 p-3 transition-all hover:bg-slate-900/50 hover:border-cyan-500/30">
                  <FormControl>
                    <Checkbox
