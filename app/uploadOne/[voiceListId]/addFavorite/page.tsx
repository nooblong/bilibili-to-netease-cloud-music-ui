    ...
    return (
        <SidebarProvider>
            ...
            <SidebarInset className="bg-gradient-to-b from-slate-950 to-blue-950 text-white relative overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 w-64 h-64 rounded-full bg-cyan-500/10 blur-3xl animate-float-delayed"></div>
                <div className="absolute top-1/3 left-1/4 w-32 h-32 rounded-full bg-blue-500/10 blur-2xl animate-pulse"></div>
                <div className="absolute bottom-1/3 right-1/4 w-24 h-24 rounded-full bg-pink-500/10 blur-2xl animate-pulse-delayed"></div>

                {/* 网格背景 */}
                <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center opacity-10"></div>

                {/* 内容 */}
                <header className="relative z-10 flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 bg-black/40 backdrop-blur-sm border-b border-cyan-500/30 px-4">
