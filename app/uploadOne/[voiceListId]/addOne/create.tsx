                            ...
                            <div className="bg-slate-900/50 border-2 border-cyan-500/30 rounded-lg p-4 h-full">
                                ...
                                >
                                    <span className="relative z-10 flex items-center justify-center">
                                        <span className="absolute left-0 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-cyan-400/20 group-hover:scale-150 group-hover:opacity-0 transition-all duration-500"></span>
                                        解析视频
                                        <span className="absolute right-0 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-cyan-400/20 group-hover:scale-150 group-hover:opacity-0 transition-all duration-500"></span>
                                    </span>
                                </SciFiButton>
                                ...
                                <div className="mt-4 transition-all duration-500">
                                    ...
                                    {videoInfo && videoInfo.image && (
                                        <div className="overflow-hidden rounded-lg border-2 border-cyan-500/30 shadow-lg shadow-cyan-500/20 transition-all duration-300 hover:shadow-cyan-500/40 hover:scale-[1.02] animate-fadeIn">
                                            <Image
                                                unoptimized
                                                width={300}
                                                height={300}
                            ...
                            <div className="space-y-5">
                                        ...
                                        <FormField
                                            ...
                                            render={() => (
                                                <FormItem>
                                                    ...
                                                    <div className="border-2 rounded-lg border-cyan-500/30 bg-slate-900/70 p-2 shadow-inner shadow-cyan-500/10">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                                                        {videoInfo &&
                                                            videoInfo.pages.map(
                                                                (item) => {
                                                                    return (
                                ...
                                <div className="bg-slate-900/50 border-2 border-cyan-500/30 rounded-lg p-4">
                                    ...
                                    <div className="space-y-3">
                                        <FormField
                                            ...
                                            name="useVideoCover"
                                            render={({ field }) => (
                                                <FormItem className="flex items-center space-x-3 p-3 rounded-lg border-2 border-cyan-500/30 bg-slate-900/70 hover:bg-slate-900/90 transition-all duration-300 hover:scale-[1.02] hover:shadow-md hover:shadow-cyan-500/20">
                                                    <FormControl>
                                                        <Checkbox
                                                            className="rounded bg-slate-900 border-cyan-400 text-cyan-400 focus:ring-cyan-500/20"
                                                            checked={
                                ...
                                >
                                    <span className="relative z-10 flex items-center justify-center py-1">
                                        <span className="inline-block w-4 h-1 bg-cyan-400 mr-2 group-hover:w-6 transition-all duration-300"></span>
                                        提交
                                        <span className="inline-block w-4 h-1 bg-cyan-400 ml-2 group-hover:w-6 transition-all duration-300"></span>
                                    </span>
                                </SciFiButton>
                            </div>
                        </div>
