...
export default async function UploadQueue({props}: { props: any }) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-500">
      <Card
        className="shadow-xl backdrop-blur-sm border border-zinc-800 bg-gradient-to-br from-zinc-900/70 to-black/80 overflow-hidden relative">
        <div className="absolute inset-0 bg-grid-white/[0.02] -z-10"/>
        <div
          className="absolute -z-10 h-32 w-full bg-gradient-radial from-primary/20 via-transparent to-transparent opacity-30 blur-xl"/>
        <CardHeader className="border-b border-zinc-800/50">
          <div className="flex items-center justify-between">
            <h2
              className="text-xl font-bold flex items-center gap-2 animate-in fade-in slide-in-from-left-5 duration-500 delay-150">
              <span className="inline-block w-2 h-2 rounded-full bg-primary animate-pulse"></span>
              总上传队列
            </h2>
            <div
              className="px-3 py-1 rounded-full bg-zinc-800 text-zinc-300 text-sm font-medium animate-in fade-in zoom-in-90 duration-500 delay-300">
      ...
      <Card
        className="shadow-xl backdrop-blur-sm border border-zinc-800 bg-gradient-to-br from-zinc-900/70 to-black/80 overflow-hidden relative animate-in fade-in slide-in-from-bottom-3 duration-500 delay-200">
        <div className="absolute inset-0 bg-grid-white/[0.02] -z-10"/>
        <div
          className="absolute -z-10 h-32 w-full bg-gradient-radial from-primary/10 via-transparent to-transparent opacity-30 blur-xl"/>
        <CardHeader className="border-b border-zinc-800/50">
          <h2
            className="text-xl font-bold flex items-center gap-2 animate-in fade-in slide-in-from-left-5 duration-500 delay-300">
            <span className="inline-block w-2 h-2 rounded-full bg-primary animate-pulse"></span>
            最近上传
          </h2>
        </CardHeader>
